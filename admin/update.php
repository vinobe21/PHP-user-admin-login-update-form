...
<body>
    ...
    if(isset($_POST['update'])){
        ...
        if($valid){
            ...
            if(!empty($file) && move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
                ...
                if ($result) {
                    header("location:home.php?Update=User Update Successfully..");
                }else{
    ...
    <div class="container">
        ...
        <form class="w-50" action="" method="POST" id="updateForm" onsubmit="return checkInputs();"
            ...
            <a href="home.php" type="button" class="btn btn-danger">Cancel</a>
